...
with col2:
    # Add a cartoon detective image on the right
    st.image("https://example.com/path/to/cartoon_detective.png", use_column_width=True)  # Replace with the actual image URL
